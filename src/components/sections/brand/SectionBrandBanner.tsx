        ...
        <div className="cusContainer">
          <div className="relative rounded-[50px] overflow-hidden w-full h-[calc(100vh-40px)]">
            ...
            <div className="content w-full max-w-[950px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
              <p className="uppercase text-[32px] leading-[1] mb-[10px] text-white text-center">
                Chương trình huấn luyện
              </p>
              <h1 className="text-[64px] text-white text-center leading-[1] mb-[10px]">
                Brand Growth Retreat®
              </h1>
              <p className="text-[32px] text-white text-center leading-[1] mb-[30px]">
