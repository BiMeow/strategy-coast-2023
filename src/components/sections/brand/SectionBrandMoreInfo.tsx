            ...
            <div className="c1 w-[42%] px-[10px] relative z-10 tl-l:w-full">
              <div className="who pl-[55px] pr-[60px] py-[100px] bg-green rounded-[50px] mb:rounded-[30px] mb-[16px] mb:p-[30px]">
                ...
                <p className="text-greenDark pr-[20px] tl-l:pr-0">
                  ...
                  <br />
                  <br />
                  Anh chị với chuyên môn khác, mới được đề bạt hay đã nắm giữ
                  công việc Marketing của công ty. Cần khoá học cấp tốc để hiểu
                  và tư duy Tăng trưởng Thương hiệu một cách chiến lược.
                  <br />
                  <br />
                  Chủ và Giám đốc doanh nghiệp SMEs. Cần hiểu để tư duy và quản
                  lý Thương hiệu của mình.
                  <br />
                  <br />
                  Creative, Account, Planner, Digital Planner của Agency trên 2
                  năm kinh nghiệm. Cần góc nhìn chiến lược toàn diện khi phát
                  triển Thương hiệu cho Khách hàng.
                  <br />
                  <br />
                  Đội nhóm của Công ty. Cần góc nhìn Tăng trưởng Thương hiệu để
                  cùng nói chung một ngôn ngữ và chia sẻ tầm nhìn, kế hoạch hành
                  động cùng nhau.
                </p>
              </div>
                ...
                <div className="">
                  <ul className="space-y-[15px] list-disc pl-[20px]">
                    <li>
                      ...
                      tạo để bạn ứng dụng ngay vào công việc hằng ngày
                    </li>
                    <li>
                    ...
                    <li>
                      Khả năng Tư duy độc lập, đặt câu hỏi và giải quyết vấn đề
                      độc lập
                    </li>
              ...
              <div className="relative rounded-[50px] mb:rounded-[30px] overflow-hidden">
                ...
                <div className="content absolute z-10 w-full h-full top-0 left-0 pt-[165px] px-[70px] pr-[90px]">
                  ...
                  <div className="grid grid-cols-[36%_64%] mx-[-35px] text-white gap-y-[25px]">
                    <p className=" text-[20px] px-[35px]">
                      Chúng tôi giúp bạn{" "}
                      <span className="font-FirsNeueMedium">KHAI MỞ</span> con
                      đường tăng trưởng thương hiệu riêng của mình, bằng cách
                      tạo ra một Trải nghiệm tràn đầy cảm hứng qua phương pháp
                      Thể nghiệm tư duy®.
                    </p>
                    <p className="px-[35px] pr-[36px]">
                      “Thể nghiệm” tức là thể hiện ra thực tế và tự nghiệm ra
                      đúng sai. Thay vì dạy kiến thức một chiều, Thể nghiệm tư
                      duy® cho bạn khoảng không gian thể hiện tư duy, quan điểm
                      và tự nghiệm ra con đường phù hợp nhất cho riêng thương
                      hiệu của mình.
                      <br />
                      <br />
                      Phương pháp này gợi mở bạn bằng những câu hỏi hay, truyền
